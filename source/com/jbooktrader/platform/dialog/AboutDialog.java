...
public class AboutDialog extends JBTDialog {
    ...
    private void init() {
        ...
        setTitle("About " + AtomicTrader.APP_NAME);
        ...
        JLabel productValueLabel = new JLabel(AtomicTrader.APP_NAME);
        ...
        JLabel versionValueLabel = new JLabel(AtomicTrader.VERSION);
        ...
        JLabel releaseDateValueLabel = new JLabel(AtomicTrader.RELEASE_DATE);
