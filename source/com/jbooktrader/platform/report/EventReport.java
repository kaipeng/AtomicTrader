...
public class EventReport extends Report {
    ...
    public EventReport() throws IOException {
        ...
        try{
        	//dispatcherString = dispatcher.getMode().getName();
        }catch(Error e){
        	dispatcherString = "";
        }
        StringBuilder startupMessage = new StringBuilder();
        startupMessage.append("New Report Started. ").append(AtomicTrader.APP_NAME).append(" version ").append(AtomicTrader.VERSION);
        report(AtomicTrader.APP_NAME + ": "+ dispatcherString, startupMessage);
        TimeZone tz = TimeZone.getDefault();
        report(AtomicTrader.APP_NAME, "All times will be reported in the local time zone: " + tz.getID() + ", " + tz.getDisplayName());
    }
    ...
    public void report(Throwable t) {
        ...
        pw.close();
        report(AtomicTrader.APP_NAME, new StringBuilder(sw.toString()));
    }
